...
public class SystemProcedureCatalog {
    ...
    static {                                                                                            // SP     RO     Every  Param ParamType           PRO    killDR skipDR replica-ok durable
        ...
        builder.put("@AdHoc_RW_NP",             new Config("org.voltdb.sysprocs.AdHoc_RW_NP",              false, false, false, 0,    VoltType.VARBINARY,   true, false, false, false,     true));
        ...
        builder.put("@AdHoc_RO_NP",             new Config("org.voltdb.sysprocs.AdHoc_RO_NP",              false, true,  false, 0,    VoltType.VARBINARY,   true, false, false, true,      false));
        ...
        builder.put("@AdHoc_NP",             	new Config("org.voltdb.sysprocs.AdHoc_NP",                 false, false, false, 0,    VoltType.VARBINARY,   true, false, false, false,     true));
